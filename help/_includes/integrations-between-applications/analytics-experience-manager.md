...
将Adobe [!DNL Analytics]与Adobe Experience Manager集成可提供多种好处，包括：

+ **精确分段**：将Adobe [!DNL Analytics]与Audience Manager合并，以实现营销活动中的个性化受众区段。
+ **全面的客户**&#x200B;配置文件：集成数据源，以便统一了解交互和行为。
+ **已优化广告定位**：通过Adobe [!DNL Analytics]和Audience Manager中的数据驱动定位增强广告效果。
+ **明智的决策**：从合并的Adobe [!DNL Analytics]和Audience Manager数据中获得详细的见解，以便做出更好的选择。
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>当您想要在Adobe [!DNL Analytics]中报告AEM Web分析数据并准备好将来与其他Experience Cloud应用程序集成时。</li>
                </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
        ...
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>当您想要在Adobe [!DNL Analytics]中报告AEM Web分析数据，并且不打算在其他Experience Cloud应用程序中使用这些数据时</li>
                    <li>将AEM的核心组件用于可跟踪网站元素时。</li>
        ...
        <tr>
            <td><a href="https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-and-analytics/introduction.html?lang=zh-Hans" target="_blank" rel="noreferrer">[!DNL Analytics] 和AEM Forms as Cloud Service</a></td>
            <td>Experience [!DNL Platform] Web SDK标记扩展</td>
            <td>
              <ul style="margin-top: 0;">
                <li>当您想要在Adobe [!DNL Analytics]中报告数字表单分析数据，并准备好将来与其他Experience Cloud应用程序集成时。</li>
              </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
