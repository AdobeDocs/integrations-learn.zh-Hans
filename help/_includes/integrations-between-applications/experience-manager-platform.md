...
<table>
    ...
    <tbody>
        <tr>
            <td><a href="https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform/web-sdk.html?lang=zh-Hans" target="_blank" rel="noreferrer">Experience Manager和Experience [!DNL Platform]</a></td>
            <td>体验[!DNL Platform] Web SDK</td>
            <td>
                <ul style="margin-top: 0;">
                    <li>适用于要定位AEM以便能够与其他Adobe Experience Cloud应用程序集成的情况。</li>
                </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
