...
<ol>
    ...
    <li>使用<a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=zh-Hans" _target="_blank" rel="noopener noreferrer">Adobe [!DNL Analytics]源连接器</a>将数据摄取到体验[!DNL Platform]</li>
