 ...
 <thead>
  ...
  <tbody>
    ...
    <tr>
      <td>
        通过以下方式协调和衡量部门中资产的创建
        集成AEM Assets Essentials和Workfront。</td>
      <td>
        <ul style="margin-top: 0;">
          <li>简化部门资产管理</li>
          <li>启用协作和批准</li>
    ...
    <tr>
      <td>
        在Creative Cloud和Workfront中创建和管理资源更新
        应用程序</td>
      <td>
        <ul style="margin-top: 0;">
          <li>跨多个平台上传和共享资产</li>
    ...
    <tr>
      ...
      <td>
        ...
        将AEM Headless与Adobe [!DNL Target]结合使用。</td>
      <td>
        <ul style="margin-top: 0;">
          <li>单页应用程序个性化。</li>
          <li>个性化API响应。</li>
