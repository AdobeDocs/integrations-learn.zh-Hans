...
<!--  ROW 2f  -->
<tr>
   <td>使用预单击量度和转化率，全面了解Adobe [!DNL Campaign]电子邮件营销活动。</td>
   <td><ul style="margin-top: 0;">
...
<!--  ROW 3d  -->
<tr>
  <td>使用Audience Manager区段在Real-Time CDP中创建受众以用于个性化和再营销。</td>
  <td><ul style="margin-top: 0;">
...
<tr>
   ...
   <td>通过集成AEM Assets和Adobe [!DNL Analytics]，跟踪和分析营销图像的有效性。</td>
